-- File changed by Piotr Waszkiewicz on 20.08.2016
...
if file.open("ap_list.txt", "r") == nil then
    ...
    print('Connecting to '..wifiConfig.stationPointConfig.ssid..' using password '..wifiConfig.stationPointConfig.pwd)
